...
{
    MODULE_METHOD_CREATE = "MODULE_METHOD_CREATE",
    MODULE_METHOD_UPDATE = "MODULE_METHOD_UPDATE",
    MODULE_METHOD_DELETE = "MODULE_METHOD_DELETE",
    MODULE_METHOD_GET = "MODULE_METHOD_GET",
    MODULE_METHOD_LIST = "MODULE_METHOD_LIST",
    MODULE_METHOD_ACTION = "MODULE_METHOD_ACTION",
    MODULE_METHOD_GET_OTHER  = "MODULE_METHOD_GET_OTHER",
    MODULE_METHOD_OTHER = "MODULE_METHOD_OTHER"
}
