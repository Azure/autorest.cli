...
function GenerateModuleRestInfo(model, collection) {
    ...
    AnsibleModuleCommon_1.AppendModuleArgSpec(output, model, false, false);
    output.push("");
    ...
    for (let mi in model.ModuleMethods) {
        ...
        output[output.length - 1] += ")";
        let fixurl = AnsibleModuleCommon_1.GetFixUrlStatements(model);
...
exports.GenerateModuleRestInfo = GenerateModuleRestInfo;
